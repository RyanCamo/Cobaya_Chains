...
# Mock Data
arr_size = int(np.genfromtxt(r"data/cov_3.txt", comments='#',dtype=None)[0])
DES5YR_UNBIN = np.genfromtxt(r"data/hubble_diagram_3.txt", names=True, comments='#')
cov_arr = np.genfromtxt(r"data/cov_3.txt", comments='#',dtype=None)[1:]
