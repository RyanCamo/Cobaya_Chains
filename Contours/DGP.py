...
c.add_chain(BAO_CMB_SN, parameters=label, weights=BAO_CMB_SN_weights,linewidth=1.0, name="BAO/CMB+SN", kde=0, color="#1E90FF",num_free_params=len(begin))
...
yaxis = label[0] # Which slice to plot?
...
ax.set_xticklabels(['','-0.20','','-0.10','','0.00','','0.10','','0.20'])
ax.vlines(0, -5, 5, colors='k', linestyles='--', alpha=0.9)
