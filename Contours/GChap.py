...
burnBAO_CMB = 1100 #int(0.01*len(BAO_CMB))
burnBAO_CMB_SN = 1100 #int(0.001*len(BAO_CMB_SN))
...
ax.hlines(0, -5, 5, colors='k', linestyles='--', alpha=0.9)
ax.scatter(1-(L_om/(1-L_K)), 0, marker = 's', s = 20, c='black', label = r'$\Lambda$')
