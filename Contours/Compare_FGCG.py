...
c.add_chain(SN_2[65:], parameters=label, weights=SN_2_weights[65:], linewidth=1.0, name="DES5YR", kde=1.5, color="red",num_free_params=len(begin))
...
ax.text(0.525,1.1,r'FGCG', family='serif',color='black',rotation=0,fontsize=16,ha='left')
