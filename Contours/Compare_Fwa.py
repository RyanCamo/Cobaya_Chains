...
ax.legend(handles=[red_patch, yellow_patch], loc='upper right',frameon=False,fontsize=16)
ax.text(-3,9,r'$w_0 w_a$', family='serif',color='black',rotation=0,fontsize=16,ha='left')
