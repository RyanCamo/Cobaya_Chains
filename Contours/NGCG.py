...
c.add_chain(SN_2[burnSN:], parameters=label, weights=SN_2_weights[burnSN:], linewidth=1.0, name="SN_2_2", kde=1.5, color="red", linestyle = '--', num_free_params=len(begin))
c.configure(summary=True, shade_alpha=1, shade=[True, True, True, False, False, False],statistics="max")
...
ax.scatter(0, -1, marker = 'o', s = 20, c='black', label = r'$\Lambda$')
