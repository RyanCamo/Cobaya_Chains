...
SN = np.loadtxt('Cobaya_Chains/chains/SN/%s_SN.1.txt' %(model), usecols=(2, 3), comments='#')
SN_weights = np.loadtxt('Cobaya_Chains/chains/SN/%s_SN.1.txt' %(model), usecols=(0), comments='#')
SN_2 = np.loadtxt('Cobaya_Chains/chains/SN_BiasCor/%s_SN_2.1.txt' %(model), usecols=(2, 3), comments='#')
...
c.configure(summary=True, shade_alpha=1, shade=[True, False, True, True],statistics="max")
...
ax.scatter(Flat_L_om, 1-Flat_L_om, marker = 'D', s = 20, c='black', label = r'Flat $\Lambda$')
